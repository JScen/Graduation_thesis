...
fn_df.to_csv("LOOCV_FN_Tree.csv", index=False, encoding="utf-8-sig")
print("\n偽陰性サンプル一覧を 'LOOCV_FN_Tree.csv' に保存しました。")
...
# feature_names = sf + cat_names
#
# model = dt_clf.named_steps["clf"]
#
# rules_full = export_text(
#     model,
#     feature_names=feature_names,
#     max_depth=1000,   # ★ 深さ制限を実質解除
#     decimals=3        # 小数点以下3桁表示（可省略）
# )
#
# with open("decision_tree_full.txt", "w", encoding="utf-8") as f:
#     f.write(rules_full)
#
# print("\n決定木全体の構造を 'decision_tree_full.txt' に保存しました。")